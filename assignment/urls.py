...
urlpatterns = [
    ...
    path('score_student_section/<int:pk>/<int:a_pk>/', views.student_result, name='score-student-section'),
    ...
    path('grade_student/<int:pk>/<str:index>/', views.grade_student, name='grade-student'),
